...
function ShowProvideInfor(inforID){
	...
	$("#PCR02").replaceWith('<form class="form-inline"  id="PCR02"><div id="distpicker-provide-infor'+provideID+'"><div class="form-group"><label class="sr-only" for="province6">Province</label><select class="select-frame12" id="providecmbProvince"></select></div><div class="form-group"><label class="sr-only" for="city6">City</label><select class="select-frame12" id="providecmbCity"></select></div><div class="form-group"><label class="sr-only" for="district6">District</label><select class="select-frame12" id="providecmbArea"></select></div></div></form>');
