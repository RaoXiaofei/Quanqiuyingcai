...
function ShowRentInfor(inforID){
	rentID = inforID.id;
	rentPriImg = '';
	$("#PCR03").replaceWith('<form class="form-inline" id="PCR03"><div id="distpicker-rent-infor'+rentID+'"><div class="form-group"><label class="sr-only" for="province6">Province</label><select class="select-frame12" id="rentcmbProvince"></select></div><div class="form-group"><label class="sr-only" for="city6">City</label><select class="select-frame12" id="rentcmbCity"></select></div><div class="form-group"><label class="sr-only" for="district6">District</label><select class="select-frame12" id="rentcmbArea"></select></div></div></form>')
	$("#SaveRent").hide();
