...
function ShowBusInfor(inforID){
	busID = inforID.id;
	$("#PCR01").replaceWith('<form class="form-inline"  id="PCR01"><div id="distpicker-bus-infor'+busID+'"><div class="form-group"><label class="sr-only" for="province6">Province</label><select class="select-frame12" id="buscmbProvince"></select></div><div class="form-group"><label class="sr-only" for="city6">City</label><select class="select-frame12" id="buscmbCity"></select></div><div class="form-group"><label class="sr-only" for="district6">District</label><select class="select-frame12" id="buscmbArea"></select></div></div></form>')
